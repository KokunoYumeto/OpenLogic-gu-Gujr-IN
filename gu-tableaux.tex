...
\input{build/tableaux-available-labels.tex}
...
\renewcommand{\ref}[1]{%
  ...
  \else
    \guoriginalref{#1}%
  \fi}
\hypersetup{pdftitle={ટેબ્લો સહિત ઓપન લોજિક ગુજરાતી}}
\begin{document}
\renewcommand{\ref}[1]{%
  \ifcsname guexternalref@#1\endcsname
    \csname guexternalref@#1\endcsname
...
સ્વાભાવિક નિગમન અને ટેબ્લો\par}
\vspace{1em}
...
આ આવૃત્તિમાં મૂળનાં ૧૦૮ એકમોનો સમાવેશ છે; કુલ ૭૨૨ એકમો છે.
...
OLND-001થી OLND-006 અને OLTAB-001થી OLTAB-012 સુધીની ઓળખવાળી
