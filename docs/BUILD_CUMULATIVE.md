...
The reviewed 170-unit artifacts are public as [First-Order Models and Theories v0.11.0](https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/releases/tag/models-theories-v0.11.0), preserved at [DOI 10.5281/zenodo.22850543](https://doi.org/10.5281/zenodo.22850543) in the existing Gujarati OpenLogic Zenodo lineage, with the PDF as the human-readable preview. Anonymous readback verified all eight artifact bytes, the direct full-text TeX, and all 1,252 source-archive inventory entries.
