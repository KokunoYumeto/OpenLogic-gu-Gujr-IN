...
Updated 2026-09-21T00:54:52.705783+00:00. This is a **complete decision log for the current 204/722-unit draft**, while the translation corpus itself remains partial. Public source-checkpoint and artifact-release verification cover 204/722 units through checkpoint 022 and v0.16.0. It contains all 198 terminology decisions from the durable ledger and all 175 source corrections identified so far, plus 1 independently reviewed source-claim qualification. It must grow with the translation.
...
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/many-sorted-logic.tex:11` (OLP-0176, “Many-Sorted Logic”); `upstream/content/first-order-logic/beyond/many-sorted-logic.tex:20` (OLP-0176, “sorts”); `upstream/content/first-order-logic/beyond/many-sorted-logic.tex:23` (OLP-0176, “typed”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/many-sorted-logic.tex:11` (OLP-0176, “બહુ-પ્રકાર તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/many-sorted-logic.tex:19` (OLP-0176, “પ્રકારો”); `gu/content/first-order-logic/beyond/many-sorted-logic.tex:23` (OLP-0176, “પ્રકારિત”)
- **Authorities actually checked:** `GU-P067` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 7, "last_line_one_based": 7, "utf8_start": 10292, "utf8_end": 12844, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** પ્રકાર transparently classifies objects into distinct ranges, and પ્રકારિત marks the argument-sort constraints on functions and relations. બહુ-પ્રકાર therefore keeps the formal distinction from a single-domain first-order language.
- **Alternatives:** બહુ-જાતિ તર્કશાસ્ત્ર — possible, but જાતિ has broader social and biological senses.; સોર્ટ / સોર્ટેડ — direct transliterations with less explanatory value.
...
- **Status and uncertainty:** `adopted_contextual`; medium. The components and formal scope are supported, but the exact specialist compound remains open to expert correction.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/second-order-logic.tex:11` (OLP-0177, “Second-Order logic”); `upstream/content/first-order-logic/beyond/higher-order-logic.tex:11` (OLP-0178, “Higher-Order logic”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/second-order-logic.tex:11` (OLP-0177, “દ્વિતીય-ક્રમ તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/higher-order-logic.tex:11` (OLP-0178, “ઉચ્ચ-ક્રમ તર્કશાસ્ત્ર”)
...
- **Chosen sense and rationale:** ક્રમ continues the edition's established પ્રથમ-ક્રમ family. દ્વિતીય marks quantification over relations, while ઉચ્ચ covers the iterated hierarchy of relation and function types without misreading order as an ordering relation.
- **Alternatives:** બીજા-ક્રમ / ઊંચા-ક્રમ — readable but less stable as scholarly labels.; દ્વિતીય-સ્તર / ઉચ્ચ-સ્તર — inconsistent with the edition's first-order terminology.
...
- **Status and uncertainty:** `adopted_contextual`; medium. The components and formal scope are supported, but the exact specialist compound remains open to expert correction.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/second-order-logic.tex:123` (OLP-0177, “full second-order semantics”); `upstream/content/first-order-logic/beyond/second-order-logic.tex:215` (OLP-0177, “weaker semantics”); `upstream/content/first-order-logic/beyond/second-order-logic.tex:119` (OLP-0177, “categorical description”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/second-order-logic.tex:120` (OLP-0177, “પૂર્ણ દ્વિતીય-ક્રમ અર્થવિજ્ઞાન”); `gu/content/first-order-logic/beyond/second-order-logic.tex:121` (OLP-0177, “દુર્બળ અર્થવિજ્ઞાન”); `gu/content/first-order-logic/beyond/second-order-logic.tex:116` (OLP-0177, “એકરૂપતા સુધીનું અનન્ય વર્ણન”)
...
- **Chosen sense and rationale:** પૂર્ણ ranges over all relations or functions of the required type, whereas દુર્બળ permits a selected second-order or higher-type domain. The descriptive phrase for categorical explicitly states uniqueness up to isomorphism and avoids the ordinary classificatory sense of categorical.
- **Alternatives:** માનક અર્થવિજ્ઞાન — retained only where the source says standard, not as a substitute for full.; શ્રેણીગત વર્ણન — risks confusion with category theory and hides uniqueness up to isomorphism.
...
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/second-order-logic.tex:57` (OLP-0177, “comprehension schema”); `upstream/content/first-order-logic/beyond/second-order-logic.tex:72` (OLP-0177, “impredicative”); `upstream/content/first-order-logic/beyond/second-order-logic.tex:72` (OLP-0177, “predicative”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/second-order-logic.tex:55` (OLP-0177, “ગુણધર્મ-ગણરચના પ્રરૂપ”); `gu/content/first-order-logic/beyond/second-order-logic.tex:71` (OLP-0177, “અપ્રેડિકેટિવ”); `gu/content/first-order-logic/beyond/second-order-logic.tex:71` (OLP-0177, “પ્રેડિકેટિવ”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P067` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 7, "last_line_one_based": 7, "utf8_start": 10292, "utf8_end": 12844, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P074` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 12, "last_line_one_based": 12, "utf8_start": 19671, "utf8_end": 21872, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** GU-T157 already governs ગુણધર્મ-ગણરચના for set comprehension. Here the same transparent head creates relations defined by formulas. The transliterated predicative contrast is fixed by the prose: અપ્રેડિકેટિવ permits second-order quantifiers over a range containing the relation being defined; પ્રેડિકેટિવ forbids them.
- **Alternatives:** બોધ-પ્રરૂપ — obscures the relation-forming operation.; અપરિભાષાત્મક / પરિભાષાત્મક — may suggest ordinary definability rather than the technical vicious-circle restriction.
...
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/higher-order-logic.tex:27` (OLP-0178, “finite types”); `upstream/content/first-order-logic/beyond/higher-order-logic.tex:37` (OLP-0178, “functionals”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/higher-order-logic.tex:27` (OLP-0178, “સાન્ત પ્રકારો”); `gu/content/first-order-logic/beyond/higher-order-logic.tex:43` (OLP-0178, “વિધેયકો”)
- **Authorities actually checked:** `GU-P067` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 7, "last_line_one_based": 7, "utf8_start": 10292, "utf8_end": 12844, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P073` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 17833, "utf8_end": 19671, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P074` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 12, "last_line_one_based": 12, "utf8_start": 19671, "utf8_end": 21872, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** સાન્ત is the edition's established finite term and પ્રકાર identifies a type in the inductively generated hierarchy. વિધેયક distinguishes a higher-type object that maps functions to numbers from an ordinary first-order વિધેય.
- **Alternatives:** સીમિત પ્રકાર — understandable but inconsistent with established સાન્ત.; ફંક્શનલ — recognizable transliteration but less integrated with established વિધેય.
...
- **Status and uncertainty:** `adopted_contextual`; medium. The components and formal scope are supported, but the exact specialist compound remains open to expert correction.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:11` (OLP-0179, “Intuitionistic Logic”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:14` (OLP-0179, “classical version”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:15` (OLP-0179, “constructive”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:11` (OLP-0179, “સ્ફુરણાવાદી તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:14` (OLP-0179, “પ્રશિષ્ટ સ્વરૂપ”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:15` (OLP-0179, “રચનાત્મક”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P073` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 17833, "utf8_end": 19671, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P074` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 12, "last_line_one_based": 12, "utf8_start": 19671, "utf8_end": 21872, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** GU-P073 directly supports સ્ફુરણાવાદ for intuitionism and its finite proof conception. પ્રશિષ્ટ distinguishes classical logic from merely traditional prose, and રચનાત્મક retains the witness-and-procedure content fixed by the examples and BHK clauses.
- **Alternatives:** અંતઃપ્રજ્ઞાવાદી — a literal philosophical rendering that does not match the checked Gujarati canon.; શાસ્ત્રીય — common for classical, but પ્રશિષ્ટ is kept consistently in this edition's logic contrast.
...
- **Status and uncertainty:** `adopted_contextual`; medium. The components and formal scope are supported, but the exact specialist compound remains open to expert correction.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:98` (OLP-0179, “BHK interpretation”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:115` (OLP-0179, “law of the excluded middle”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:135` (OLP-0179, “double-negation translation”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:87` (OLP-0179, “BHK અર્થઘટન”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:101` (OLP-0179, “મધ્યનો નિયમ”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:121` (OLP-0179, “દ્વિનિષેધ અનુવાદ”)
...
- **Chosen sense and rationale:** The initials remain the standard names of Brouwer, Heyting and Kolmogorov, while અર્થઘટન states the proof interpretation. વર્જિત મધ્ય names the excluded alternative, and દ્વિનિષેધ composes the edition's established negation term; the displayed clauses control the translation exactly.
- **Alternatives:** મધ્યનિવારણનો નિયમ — possible explanatory paraphrase but less recognizable as the standard law.; બેવડો નિષેધ અનુવાદ — plainer but less compact than the established compound style.
...
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:196` (OLP-0179, “Kripke !!{structure}”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:207` (OLP-0179, “forcing relation”); `upstream/content/first-order-logic/beyond/intuitionistic-logic.tex:202` (OLP-0179, “monotone”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:180` (OLP-0179, “ક્રિપ્કે !!{structure}”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:191` (OLP-0179, “બાધન-સંબંધ”); `gu/content/first-order-logic/beyond/intuitionistic-logic.tex:186` (OLP-0179, “એકદિશવર્ધી”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P070` (GU-VK-TRUTH, {"line_one_based": 110, "last_line_one_based": 110, "utf8_start": 39315, "utf8_end": 40735, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** The eponym is transliterated and સંરચના follows the established structure term. બાધન names forcing without confusing it with ordinary truth at one world, while એકદિશવર્ધી states persistence upward in the information order; the five clauses and order condition fix both technical senses.
- **Alternatives:** ફોર્સિંગ સંબંધ — recognizable but needlessly leaves the technical head untranslated.; એકવિધવર્ધી નિયુક્તિ — possible, but less transparent about one-directional growth.
...
- **Status and uncertainty:** `provisional_contextual`; open. No checked authority fully settled this exact specialist expression; treat it as provisional.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/modal-logics.tex:11` (OLP-0180, “Modal Logics”); `upstream/content/first-order-logic/beyond/modal-logics.tex:50` (OLP-0180, “intensional”); `upstream/content/first-order-logic/beyond/modal-logics.tex:44` (OLP-0180, “accessibility”); `upstream/content/first-order-logic/beyond/modal-logics.tex:44` (OLP-0180, “possible worlds”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/modal-logics.tex:11` (OLP-0180, “મોડલ તર્કશાસ્ત્રો”); `gu/content/first-order-logic/beyond/modal-logics.tex:46` (OLP-0180, “અંતર્લક્ષી”); `gu/content/first-order-logic/beyond/modal-logics.tex:41` (OLP-0180, “સુલભતા”); `gu/content/first-order-logic/beyond/modal-logics.tex:40` (OLP-0180, “શક્ય જગતો”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P070` (GU-VK-TRUTH, {"line_one_based": 110, "last_line_one_based": 110, "utf8_start": 39315, "utf8_end": 40735, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** મોડલ preserves the recognized specialist label. અંતર્લક્ષી and વિસ્તારલક્ષી mark dependence on intensional content versus extension. સુલભતા describes the world-to-world relation, and શક્ય જગત retains the explicitly modal rather than temporal reading fixed by the surrounding semantics.
- **Alternatives:** પ્રકારાત્મક તર્કશાસ્ત્ર for modal — misleading because mode here is necessity and possibility, not a type.; પહોંચ સંબંધ — colloquial and can suggest physical reachability.
...
- **Status and uncertainty:** `provisional_descriptive`; open. No checked authority fully settled this exact specialist expression; treat it as provisional.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/modal-logics.tex:59` (OLP-0180, “provability logic”); `upstream/content/first-order-logic/beyond/modal-logics.tex:61` (OLP-0180, “epistemic logic”); `upstream/content/first-order-logic/beyond/modal-logics.tex:63` (OLP-0180, “temporal logic”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/modal-logics.tex:61` (OLP-0180, “સાબિતીયોગ્યતા તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/modal-logics.tex:63` (OLP-0180, “જ્ઞાનમીમાંસક તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/modal-logics.tex:65` (OLP-0180, “કાલિક તર્કશાસ્ત્ર”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P070` (GU-VK-TRUTH, {"line_one_based": 110, "last_line_one_based": 110, "utf8_start": 39315, "utf8_end": 40735, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P074` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 12, "last_line_one_based": 12, "utf8_start": 19671, "utf8_end": 21872, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** Each compound names the interpretation of the modal operators: being provable, being known or believed, and holding always or sometimes in time. The adjacent box and diamond readings prevent these labels from drifting into broader philosophy.
- **Alternatives:** પ્રમેયતા તર્કશાસ્ત્ર — can suggest theoremhood rather than provability in a system.; સમયલક્ષી તર્કશાસ્ત્ર — clear alternative, but કાલિક is the more compact technical label.
...
- **Status and uncertainty:** `provisional_descriptive`; open. No checked authority fully settled this exact specialist expression; treat it as provisional.
- **Record origin:** contemporaneous_beyond_first_order_translation; `work/add_beyond_terms.py`.
- **English use:** `upstream/content/first-order-logic/beyond/other-logics.tex:23` (OLP-0181, “Fuzzy logic”); `upstream/content/first-order-logic/beyond/other-logics.tex:24` (OLP-0181, “Probabilistic logic”); `upstream/content/first-order-logic/beyond/other-logics.tex:25` (OLP-0181, “nonmonotonic logics”); `upstream/content/first-order-logic/beyond/other-logics.tex:26` (OLP-0181, “defeasible forms”); `upstream/content/first-order-logic/beyond/other-logics.tex:29` (OLP-0181, “causal logics”); `upstream/content/first-order-logic/beyond/other-logics.tex:31` (OLP-0181, “deontic”)
- **Gujarati use:** `gu/content/first-order-logic/beyond/other-logics.tex:22` (OLP-0181, “અસ્પષ્ટ તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/other-logics.tex:23` (OLP-0181, “સંભાવ્યતા તર્કશાસ્ત્ર”); `gu/content/first-order-logic/beyond/other-logics.tex:24` (OLP-0181, “અ-એકદિશવર્ધી તર્કશાસ્ત્રો”); `gu/content/first-order-logic/beyond/other-logics.tex:25` (OLP-0181, “પરાજેય તર્કવિચાર”); `gu/content/first-order-logic/beyond/other-logics.tex:28` (OLP-0181, “કારણાત્મક તર્કશાસ્ત્રો”); `gu/content/first-order-logic/beyond/other-logics.tex:30` (OLP-0181, “કર્તવ્યલક્ષી”)
- **Authorities actually checked:** `GU-P065` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 5, "last_line_one_based": 5, "utf8_start": 6117, "utf8_end": 8867, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P073` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 17833, "utf8_end": 19671, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P074` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 12, "last_line_one_based": 12, "utf8_start": 19671, "utf8_end": 21872, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P075` (GU-VK-WITTGENSTEIN, {"line_one_based": 11, "last_line_one_based": 11, "utf8_start": 14904, "utf8_end": 17212, "byte_basis": "UTF-8 raw extract bytes"}); `GU-P077` (GU-VK-MATHEMATICAL-LOGIC, {"line_one_based": 2, "last_line_one_based": 2, "utf8_start": 1405, "utf8_end": 3561, "byte_basis": "UTF-8 raw extract bytes"})
- **Chosen sense and rationale:** The forms follow the source's explicit explanatory scopes: vagueness, probability, defaults, withdrawal under new information, causation and obligation. અ-એકદિશવર્ધી contrasts directly with the established monotonic-growth family, and પરાજેય marks an inference that can be defeated rather than a false or invalid inference.
...
### OLBYD-001: confirmed_missing_quantifier_argument_bracket

- **Frozen source:** `upstream/content/first-order-logic/beyond/many-sorted-logic.tex` at `many-sorted-logic.tex:38`; SHA-256 `5a6abcd66e91868de97e0c1ec44cdf848396655cc6995adc05d6771844ecfac7`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/many-sorted-logic.tex` body line(s) 36; adjacent note line 42; SHA-256 `9920603f0eb8afde13e3657e2d4b4a9adacdc4997cf36a61ace114ab7e87a27d`.
- **Chosen handling:** Restored the bracketed argument of the inner quantifier and added an adjacent keyed note.
- **Rationale:** The inner sorted universal quantifier lacks the opening square bracket required by the logical macro.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
- **Review question:** Does the Gujarati handling at the listed body and note lines fully and accurately repair OLBYD-001 without changing any unaffected claim or formula?

### OLBYD-002: confirmed_inconsistent_successor_notation

- **Frozen source:** `upstream/content/first-order-logic/beyond/second-order-logic.tex` at `second-order-logic.tex:142`; SHA-256 `944e224c99309c16e3303d6688fe0bf070e9ad8a68a1207ef6b8d6add08fe16d`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/second-order-logic.tex` body line(s) 137; adjacent note line 144; SHA-256 `9f2c786f7696c28e4f20769ae4f0955aeb67d22d1d0e47f3b483c5556481dfc0`.
- **Chosen handling:** Used the declared prime successor notation consistently and added an adjacent keyed note.
- **Rationale:** The successor-injectivity axiom uses an undeclared s notation although the language has just declared prime as its successor symbol.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
- **Review question:** Does the Gujarati handling at the listed body and note lines fully and accurately repair OLBYD-002 without changing any unaffected claim or formula?

### OLBYD-006: confirmed_glossary_token_embedded_in_verb_inflection

- **Frozen source:** `upstream/content/first-order-logic/beyond/higher-order-logic.tex` at `higher-order-logic.tex:21`; SHA-256 `38ced5d3bad860479a37abcc7745229561d26bbfdbe77a5b2a1c6dece2a455b1`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/higher-order-logic.tex` body line(s) 21; adjacent note line 30; SHA-256 `51c2a9807d461ce61555ddd2684cbc8b713cfe95526dca04f38698a107c2e08b`.
- **Chosen handling:** Translated the coherent verb without noun glossary markup and added an adjacent keyed note.
- **Rationale:** Noun glossary markup is embedded inside the English verb formulated, leaving an invalid tokenized inflection.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
- **Review question:** Does the Gujarati handling at the listed body and note lines fully and accurately repair OLBYD-006 without changing any unaffected claim or formula?

### OLBYD-003: confirmed_lambda_bound_variable_type_mismatch

- **Frozen source:** `upstream/content/first-order-logic/beyond/higher-order-logic.tex` at `higher-order-logic.tex:87`; SHA-256 `38ced5d3bad860479a37abcc7745229561d26bbfdbe77a5b2a1c6dece2a455b1`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/higher-order-logic.tex` body line(s) 95; adjacent note line 98; SHA-256 `51c2a9807d461ce61555ddd2684cbc8b713cfe95526dca04f38698a107c2e08b`.
- **Chosen handling:** Restored tau as the bound variable's type and added an adjacent keyed note.
- **Rationale:** The explanatory sentence assigns x type sigma, contrary to the preceding formation clause where x has type tau and the abstraction has type tau to sigma.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
- **Review question:** Does the Gujarati handling at the listed body and note lines fully and accurately repair OLBYD-003 without changing any unaffected claim or formula?

### OLBYD-004: confirmed_malformed_glossary_token

- **Frozen source:** `upstream/content/first-order-logic/beyond/higher-order-logic.tex` at `higher-order-logic.tex:89`; SHA-256 `38ced5d3bad860479a37abcc7745229561d26bbfdbe77a5b2a1c6dece2a455b1`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/higher-order-logic.tex` body line(s) 103; adjacent note line 108; SHA-256 `51c2a9807d461ce61555ddd2684cbc8b713cfe95526dca04f38698a107c2e08b`.
- **Chosen handling:** Restored the standard plural formula token and added an adjacent keyed note.
- **Rationale:** The glossary markup for formulas contains a stray caret and therefore does not match the project's token syntax.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
- **Review question:** Does the Gujarati handling at the listed body and note lines fully and accurately repair OLBYD-004 without changing any unaffected claim or formula?

### OLBYD-005: confirmed_glossary_token_embedded_in_verb_inflection

- **Frozen source:** `upstream/content/first-order-logic/beyond/modal-logics.tex` at `modal-logics.tex:54`; SHA-256 `8dff5692c79c06aa452bc0e20871109f3334a9232bd18997062196e872539881`.
- **Gujarati target:** `gu/content/first-order-logic/beyond/modal-logics.tex` body line(s) 50; adjacent note line 54; SHA-256 `bb7d9bdac9c60f94d48ef092c1823064fc9a00a93e56baa9f336ea2f08ff941c`.
- **Chosen handling:** Translated both coherent verb uses without noun glossary markup and added an adjacent keyed note.
- **Rationale:** Noun glossary markup is embedded inside two English verb forms, producing invalid tokenized inflections rather than the intended verbs.
- **Alternatives:** Preserve the false or imprecise English wording literally — rejected. Correct silently — rejected because the inherited source defect must remain traceable. Correct the Gujarati body and add an adjacent keyed note — adopted.
- **Uncertainty:** The correction is applied, but mathematical and editorial review remains welcome.
