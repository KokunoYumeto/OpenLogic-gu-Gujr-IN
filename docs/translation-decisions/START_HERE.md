...
- `TRANSLATION_DECISIONS_FULL.md` presents all 200 decisions in readable form.
- `PRIORITY_REVIEW.md` isolates 85 urgent or high-priority items.
- `DECISION_OCCURRENCES.csv` flattens all 208 exact source/target occurrence records.
...
Reader locations currently include 207 verified PDF
