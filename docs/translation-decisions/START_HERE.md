...
This directory is the review entry point for the current 194/722-unit Gujarati
working edition.

- `DECISIONS.json` is the canonical schema-valid register.
- `TRANSLATION_DECISIONS_FULL.md` presents all 342 decisions in readable form.
- `PRIORITY_REVIEW.md` isolates 146 urgent or high-priority items.
- `DECISION_OCCURRENCES.csv` flattens all 350 exact source/target occurrence records.
...
Reader locations currently include 348 verified PDF
