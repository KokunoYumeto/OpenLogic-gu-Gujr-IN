...
- `TRANSLATION_DECISIONS_FULL.md` presents all 167 decisions in readable form.
- `PRIORITY_REVIEW.md` isolates 82 urgent or high-priority items.
- `DECISION_OCCURRENCES.csv` flattens all 175 exact source/target occurrence records.
...
Reader locations currently include 174 verified PDF
