...
- `TRANSLATION_DECISIONS_FULL.md` presents all 161 decisions in readable form.
- `PRIORITY_REVIEW.md` isolates 82 urgent or high-priority items.
- `DECISION_OCCURRENCES.csv` flattens all 169 exact source/target occurrence records.
...
Reader locations currently include 168 verified PDF
