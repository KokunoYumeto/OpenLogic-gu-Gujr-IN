...
\input{build/sequent-calculus-available-labels.tex}
...
\renewcommand{\ref}[1]{%
  ...
  \else
    \guoriginalref{#1}%
  \fi}
\hypersetup{pdftitle={સિક્વન્ટ કલન સહિત ઓપન લોજિક ગુજરાતી}}
\begin{document}
\renewcommand{\ref}[1]{%
  \ifcsname guexternalref@#1\endcsname
    \csname guexternalref@#1\endcsname
...
અનંત ગણો, વિધાનાત્મક તર્કશાસ્ત્ર, નિષ્પત્તિ તંત્રો અને સિક્વન્ટ કલન\par}
\vspace{1em}
...
માટે ગેન્ટ્ઝનનું સિક્વન્ટ કલન LK ઉમેર્યું છે. તેમાં વિધાનાત્મક અને
પરિમાણક નિયમો, સંરચનાત્મક નિયમો, નિષ્પત્તિઓ, સુસંગતતા, યથાર્થતા અને
અભિન્નતાનો સમાવેશ છે.\par
\vfill
આ યંત્ર દ્વારા કરેલો અનુવાદ છે. સંપૂર્ણ ગ્રંથનું કામ ચાલુ છે.
આ આવૃત્તિમાં મૂળનાં ૮૦ એકમોનો સમાવેશ છે; કુલ ૭૨૨ એકમો છે.
...
\tableofcontents
\clearpage
\input{build/sequent-calculus-body.tex}
\clearpage
...
OLPRF-001થી OLPRF-004 અને OLSEQ-001થી OLSEQ-006 સુધીની ઓળખવાળી
...
સિક્વન્ટ કલનના નવા પ્રકરણમાં સ્થિર મૂળની પ્રથમ-ક્રમ ગોઠવણી પસંદ કરી
છે. તેથી પરિમાણક અને અભિન્નતાના નિયમો સામેલ છે. આઇગનચલ માટેનું
ગુજરાતી રૂપ કામચલાઉ છે અને નિષ્ણાત ચકાસણી માટે ચિહ્નિત છે.
