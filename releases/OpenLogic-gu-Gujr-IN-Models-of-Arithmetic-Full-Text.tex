% OpenLogic Gujarati v0.14.0 cumulative full-text source.
% This file materializes the exact 194-unit reader body, label index, and base driver.
% External OpenLogic styles, fonts, and diagram assets remain in the companion source ZIP.
% Generated from the anonymously verified models-arithmetic-v0.14.0 checkpoint.
...
\tableofcontents
\clearpage
% BEGIN MATERIALIZED 194-unit cumulative Gujarati body
\part{ગણો}
...
\end{thm}
% END MATERIALIZED 194-unit cumulative Gujarati body
\clearpage
