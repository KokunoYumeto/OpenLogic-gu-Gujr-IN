% OpenLogic Gujarati v0.12.0 cumulative full-text source.
% This file materializes the exact 178-unit reader body, label index, and base driver.
% External OpenLogic styles, fonts, and diagram assets remain in the companion source ZIP.
% Generated from the anonymously verified beyond-v0.12.0 checkpoint.
...
\tableofcontents
\clearpage
% BEGIN MATERIALIZED 178-unit cumulative Gujarati body
\part{ગણો}
...
% END MATERIALIZED 178-unit cumulative Gujarati body
\clearpage
