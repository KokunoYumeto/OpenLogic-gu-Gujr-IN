% OpenLogic Gujarati v0.11.0 cumulative full-text source.
% This file materializes the exact 170-unit reader body, label index, and base driver.
% External OpenLogic styles, fonts, and diagram assets remain in the companion source ZIP.
% Generated from the anonymously verified models-theories-v0.11.0 checkpoint.
...
\tableofcontents
\clearpage
% BEGIN MATERIALIZED 170-unit cumulative Gujarati body
\part{ગણો}
...
% END MATERIALIZED 170-unit cumulative Gujarati body
\clearpage
