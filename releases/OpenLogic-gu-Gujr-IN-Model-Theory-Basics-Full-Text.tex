% OpenLogic Gujarati v0.13.0 cumulative full-text source.
% This file materializes the exact 187-unit reader body, label index, and base driver.
% External OpenLogic styles, fonts, and diagram assets remain in the companion source ZIP.
% Generated from the anonymously verified model-theory-basics-v0.13.0 checkpoint.
...
\tableofcontents
\clearpage
% BEGIN MATERIALIZED 187-unit cumulative Gujarati body
\part{ગણો}
...
\end{rem}
% END MATERIALIZED 187-unit cumulative Gujarati body
\clearpage
