...
INPUT = ROOT / "reader" / "first-order-introduction.html"
CSS = ROOT / "reader" / "reader.css"
ASSETS = ROOT / "reader" / "assets"
FONTS = ROOT / "fonts"
OUTPUT = ROOT / "releases" / "OpenLogic-gu-Gujr-IN-First-Order-Introduction.epub"
REPLAY = ROOT / "build" / "OpenLogic-gu-Gujr-IN-First-Order-Introduction-replay.epub"
STAGE = ROOT / "build" / "epub014-stage"
REPLAY_STAGE = ROOT / "build" / "epub014-replay-stage"
RECEIPT = ROOT / "build" / "EPUB_BUILD_RECEIPT_014.json"

TITLE = "પ્રથમ-ક્રમ પરિચય સહિત ઓપન લોજિક ગુજરાતી"
LANGUAGE = "gu-IN"
IDENTIFIER = (
    "https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/"
    "releases/tag/first-order-introduction-v0.8.0"
)
...
if EDITION == "first-order-syntax":
    ...
    INPUT = ROOT / "reader" / "first-order-semantics.html"
    OUTPUT = ROOT / "releases" / "OpenLogic-gu-Gujr-IN-First-Order-Semantics.epub"
    REPLAY = ROOT / "build" / "OpenLogic-gu-Gujr-IN-First-Order-Semantics-replay.epub"
    STAGE = ROOT / "build" / "epub016-stage"
    REPLAY_STAGE = ROOT / "build" / "epub016-replay-stage"
    RECEIPT = ROOT / "build" / "EPUB_BUILD_RECEIPT_016.json"
    TITLE = "પ્રથમ-ક્રમ અર્થવિચાર સહિત ઓપન લોજિક ગુજરાતી"
    IDENTIFIER = (
        "https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/"
        "releases/tag/first-order-semantics-v0.10.0"
    )
    MODIFIED = "2026-09-19T00:00:00Z"
    ZIP_TIME = (2026, 9, 19, 0, 0, 0)
    NAVIGATION_ENTRIES = 171
    COVERAGE = "163/722 units; OLP-0004-0166"
    DESCRIPTION = "Partial Gujarati cumulative edition: 163 of 722 tracked source units, OLP-0004-0166."
    ABOUT_COVERAGE = (
        "આ EPUB એક પ્રવાહી, લિપિઆકાર બદલાય એવું ગુજરાતી વાચન છે. તેમાં ૭૨૨ "
        "મૂળ એકમોમાંથી ૧૬૩ એકમો, એટલે OLP-0004થી OLP-0166 સુધીનો સતત "
        "આંશિક વિસ્તાર છે. સંપૂર્ણ ૭૨૨-એકમ આવૃત્તિનું કામ ચાલુ છે."
    )
    ABOUT_SCOPE = (
        "આ સંગ્રહમાં ગણો, સંબંધો, વિધેયો, ગણોનું કદ, અંકગણિતીકરણ, અનંત ગણો, "
    ...
    INPUT = ROOT / "reader" / "model-theory-basics.html"
    OUTPUT = ROOT / "releases" / "OpenLogic-gu-Gujr-IN-Model-Theory-Basics.epub"
    REPLAY = ROOT / "build" / "OpenLogic-gu-Gujr-IN-Model-Theory-Basics-replay.epub"
    STAGE = ROOT / "build" / "epub019-stage"
    REPLAY_STAGE = ROOT / "build" / "epub019-replay-stage"
    RECEIPT = ROOT / "build" / "EPUB_BUILD_RECEIPT_019.json"
    TITLE = "નિદર્શસિદ્ધાંતના પાયા સહિત ઓપન લોજિક ગુજરાતી"
    IDENTIFIER = (
        "https://github.com/KokunoYumeto/OpenLogic-gu-Gujr-IN/"
        "releases/tag/model-theory-basics-v0.13.0"
    )
    MODIFIED = "2026-09-20T00:00:00Z"
    ZIP_TIME = (2026, 9, 20, 0, 0, 0)
    NAVIGATION_ENTRIES = 193
    COVERAGE = "187/722 units; OLP-0004-0190"
    DESCRIPTION = "Partial Gujarati cumulative edition: 187 of 722 tracked source units, OLP-0004-0190."
    ABOUT_COVERAGE = (
        "આ EPUB એક પ્રવાહી, લિપિઆકાર બદલાય એવું ગુજરાતી વાચન છે. તેમાં ૭૨૨ "
        "મૂળ એકમોમાંથી ૧૮૭ એકમો, એટલે OLP-0004થી OLP-0190 સુધીનો સતત "
        "આંશિક વિસ્તાર છે. સંપૂર્ણ ૭૨૨-એકમ આવૃત્તિનું કામ ચાલુ છે."
    )
    ABOUT_SCOPE = (
        "આ સંગ્રહમાં ગણો, સંબંધો, વિધેયો, ગણોનું કદ, અંકગણિતીકરણ, અનંત ગણો, "
