"""Verify that the materialized 248-unit TeX reproduces the accepted reader PDF."""
...
SOURCE = ROOT / "releases/OpenLogic-gu-Gujr-IN-Computability-Theory-Full-Text.tex"
PDF = ROOT / "releases/OpenLogic-gu-Gujr-IN-Computability-Theory.pdf"
RECEIPT = STATE / "work/fulltext024/BUILD_RECEIPT_024.json"
OUTPUT = STATE / "FULL_TEXT_SOURCE_QA_024.json"
MATERIALIZATION = STATE / "FULL_TEXT_SOURCE_MATERIALIZATION_024.json"
...
materialization = json.loads(MATERIALIZATION.read_text(encoding="utf-8-sig"))
...
qa = {
    "schema": "openlogic-gu-full-text-source-qa/24",
