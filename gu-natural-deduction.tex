...
\input{build/natural-deduction-available-labels.tex}
...
\renewcommand{\ref}[1]{%
  ...
  \else
    \guoriginalref{#1}%
  \fi}
\hypersetup{pdftitle={સ્વાભાવિક નિગમન સહિત ઓપન લોજિક ગુજરાતી}}
\begin{document}
\renewcommand{\ref}[1]{%
  \ifcsname guexternalref@#1\endcsname
    \csname guexternalref@#1\endcsname
...
માટે સ્વાભાવિક નિગમન ઉમેર્યું છે. તેમાં વિધાનાત્મક અને પરિમાણક
પરિચય તથા નિવારણ નિયમો, ધારણાનું નિવર્તન, નિષ્પત્તિઓ,
સાબિતી-સૈદ્ધાંતિક ખ્યાલો, સુસંગતતા, યથાર્થતા અને તાદાત્મ્યનો સમાવેશ છે.\par
\vfill
આ યંત્ર દ્વારા કરેલો અનુવાદ છે. સંપૂર્ણ ગ્રંથનું કામ ચાલુ છે.
આ આવૃત્તિમાં મૂળનાં ૯૪ એકમોનો સમાવેશ છે; કુલ ૭૨૨ એકમો છે.
...
\tableofcontents
\clearpage
\input{build/natural-deduction-body.tex}
\clearpage
...
OLPRF-001થી OLPRF-004, OLSEQ-001થી OLSEQ-006 અને
OLND-001થી OLND-006 સુધીની ઓળખવાળી
...
સ્વાભાવિક નિગમનના નવા પ્રકરણમાં સ્થિર મૂળની શાસ્ત્રીય પ્રથમ-ક્રમ
ગોઠવણી પસંદ કરી છે. તેથી પરિમાણક, તાદાત્મ્ય અને શાસ્ત્રીય
$\FalseCl$ નિયમ સામેલ છે. આઇગનચલ અને ધારણા-નિવર્તન માટેનાં ગુજરાતી
રૂપો કામચલાઉ છે અને નિષ્ણાત ચકાસણી માટે ચિહ્નિત છે.
